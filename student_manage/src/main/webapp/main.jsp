...
<div region="north" style="height: 80px;background-color: #E0EDFF">
    ...
    <div style="padding-top: 50px;padding-right: 20px;">当前用户：&nbsp;<font color="red">${currentUser.userName }</font> <a href="login1.html" style="border: 1px solid seashell ; background: seashell">退出登录</a>
    </div>
